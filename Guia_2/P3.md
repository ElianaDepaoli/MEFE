...
Entonces, para maximizar sus chances de ganar apostando al diez, deberían tirar los dados entre 60 y 64 veces.
...
Para $p = 0.5$ se recupera la simetría del combinatorio $\binom{n}{k} = \frac{n!}{n!(n-k)!} = \frac{n!}{(n-k)!n!} = \binom{n}{n-k}$ pues $B(k;n,0.5) = \binom{n}{k} 0.5^{n} = B(n-k;n,0.5)$
